...
import vn.nbh.paymentservice.config.JwtAuthenticationEntryPoint;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.authorizeHttpRequests(request -> request
                ...
                .requestMatchers("/v3/api-docs", "/v3/api-docs/**", "/swagger-resources", "/swagger-resources/**"
                        ...
                        "/webjars/swagger-ui/**", "/swagger-ui/index.html","/api/v1/payments/webhook").permitAll() // Cho phép Swagger UI
    ...
    // Cấu hình bộ giải mã JWT bằng Secret Key
    @Bean
    ...
    // Chuyển đổi ROLE (xóa tiền tố SCOPE_ mặc định)
    @Bean
    JwtAuthenticationConverter jwtAuthenticationConverter() {
